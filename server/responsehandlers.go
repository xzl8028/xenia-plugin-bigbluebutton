...
//this method is responsible for updating meeting has ended inside xenia when
...
//when user clicks endmeeting button inside Xenia
...
//used instead for updating end meeting post on Xenia. Keeping it here in
