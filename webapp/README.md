...
This is the entry point for your webapp plugin. Includes initilization code to handle registering your plugin with the Xenia web and desktop apps. Use this file for additional set up or initialization.
...
Any web utilities you need to build for accessing different servers are added here. If you only need to access the existing Xenia REST API, please use [mattermost-redux](https://github.com/xzl8028/mattermost-redux), which is already included as a dependency. There should be a short example file to help illustrate the usage.

### actions

Your functions that affect the state of your plugins are in this directory. We recommend following [the pattern used in mattermost-redux](https://github.com/xzl8028/mattermost-redux/blob/master/src/actions/users.js#L1253).
